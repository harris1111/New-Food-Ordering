...
public interface OrderOrBuilder extends
   ...
   */
  java.util.List<com.example.p4f_project.protocols.Food> 
      getFoodListList();
  /**
   * <code>repeated .p4f_protocols.Food foodList = 4;</code>
   */
  com.example.p4f_project.protocols.Food getFoodList(int index);
  /**
   * <code>repeated .p4f_protocols.Food foodList = 4;</code>
   */
   ...
   * <code>repeated .p4f_protocols.Food foodList = 4;</code>
   */
  java.util.List<? extends com.example.p4f_project.protocols.FoodOrBuilder> 
      getFoodListOrBuilderList();
  /**
   * <code>repeated .p4f_protocols.Food foodList = 4;</code>
   */
  com.example.p4f_project.protocols.FoodOrBuilder getFoodListOrBuilder(
      int index);
}
